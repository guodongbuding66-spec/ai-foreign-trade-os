...
export async function onRequestGet(context) {
  ...
  try{
    ...
    return Response.json({ok:true,bound:true,binding:'DB',schemaReady:missingTables.length===0&&String(schemaVersion)==='5',schemaVersion,expectedSchemaVersion:'5',tables,missingTables,counts},{headers:{'Cache-Control':'no-store'}});
