...
import { aiCredentialsSchemaError, buildUserAIEnv, encryptAIKey, getAIUserPreferences, getPersonalCredentialRows, publicCredential, validateCredentialInput, cleanAIProviderId } from '../../../_lib/ai-credentials.js';
...
export async function onRequestPost(context){
  ...
  try{
    ...
    await audit(context,{tenantId,userId},'ai.credential.save','ai_provider_credential',input.providerId,null,{providerId:input.providerId,model:input.model||null,last4,personal:true});
